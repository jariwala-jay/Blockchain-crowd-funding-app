...
describe('Campaigns', () => {
    it('Deployes a factory and campaigns', () => {
    ...
    it('Allows People to Contrivute and Mark Approver', async () => {
    ...
    it('Minimum Amount for approver', async () => {
    ...
    it('Allows Manager to make request', async () => {
        await campaign.methods.createRequest('test request','100',accounts[1]).send({
            from: accounts[0],
            gas: '1000000'
        });
